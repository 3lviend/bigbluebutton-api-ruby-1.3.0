  ...
  class BigBlueButtonApi
    ...
    def send_api_request(method, params={}, data=nil, raw=false)
      ...
      if raw
        ...
        if @http_response.code.eql?("400")
          raise BigBlueButtonException.new("400 The plain HTTP request was sent to HTTPS port. Is the API URL correct? \"#{@url}\", version #{@version}")
        end
        # 'Hashify' the XML
